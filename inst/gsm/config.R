...
OUTPUTDIR <- "/tmp/MODELS.cory.brain.bulk.scaled.newgh"
...
#------------------------------------------------------------------------------------------------------------------------
# cory's AD method, now implemented in TrenaProjectHG39/R/GeneHancerDB.R
...
determineRegulatoryRegions <- function(gene)
{
  ...
  tbl.ghSupplemented <- getGeneRegulatoryRegions(trenaProj, targetGene=gene, tissues="all",
